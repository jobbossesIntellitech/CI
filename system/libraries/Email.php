...
class CI_Email {
	...
	var	$smtp_host		= "smtp.pixelaura.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "rajan_middha@pixelaura.com";		// SMTP Username
	var	$smtp_pass		= "r#ajan#321";		// SMTP Password
